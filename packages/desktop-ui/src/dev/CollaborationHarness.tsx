 ...
 * (`MeetingsSurface.tsx:733-738`); ta fikstura deklarowała `platform: "other"`,
 ...
 * (`MeetingsSurface.tsx:937`), a bramka chodzi po JEDNYM adresie
      ...
      items: [
        {
          ...
          // (`TodaySurface.tsx:203-209`: którykolwiek dzisiejszy wiersz planu
          ...
          // grancie (`TodaySurface.tsx:66-72`), więc inny identyfikator dałby
