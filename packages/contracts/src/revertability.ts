...
> = {
  ...
  "document.create": "never",
  "knowledge.sourceCreate": "never",
  ...
  "relationship.organizationCreate": "never",
  "relationship.personCreate": "never",
  "opportunity.create": "never",
  "opportunity.offerCreate": "never",
  "opportunity.linkOutcomes": "never",
  "relationship.renewalCreate": "never",
  "relationship.renewalResolve": "never",
  "relationship.factCreate": "never",
  "decision.create": "never",
  "decision.supersede": "never",
  "decision.resolveImpact": "never",
  "area.create": "never",
  "area.updateResponsibility": "always",
  "initiative.create": "never",
