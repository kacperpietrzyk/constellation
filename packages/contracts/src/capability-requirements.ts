...
> = {
  ...
  "project.checkInAdd": { capability: "project.checkInAdd" },
  "project.reclassify": { capability: "project.reclassify" },
  ...
  "area.archive": { capability: "area.updateResponsibility" },
  "area.restore": { capability: "area.updateResponsibility" },
  ...
  "initiative.close": { capability: "initiative.updateOutcome" },
  "initiative.reopen": { capability: "initiative.updateOutcome" },
...
> = {
  ...
  "project.reclassificationPreview": { capability: "project.reclassify" },
  ...
  "area.operationalOverview": { capability: "work.overview" },
  "initiative.operationalOverview": { capability: "work.overview" },
