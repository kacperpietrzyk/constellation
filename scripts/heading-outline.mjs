...
//   `.sr-only` headings exist in the product — `MeetingsSurface.tsx:637`
//   (`h1#surface-title`, loading state) and `Wave2Surfaces.tsx:1104`
...
//   • `pipeline/PipelineSurface.tsx:834,844` i `people/PeopleSurface.tsx:578,723`
